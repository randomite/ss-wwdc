        ...
        if(count == 0){
            UIView.animateWithDuration(1.5, animations: {
                ...
                self.businessIconButton.alpha = 0.0
                    ...
                    if(finished){
                        UIView.animateWithDuration(0.75, animations: {
                            self.vcTextView.text = "Software is nothing without hardware and I believe it is imperative for hardware to run optimally and effectively with software. In order to venture into this interest, I tinker with Raspberry Pi, Arduino, as well as my own circuitry. I love creating intuitive software around these hardware projects to help make something better. One example of this is my home automation project in which I connected a Raspberry Pi and Sparkcore to my garage door. To connect the hardware to software, I made an iOS and Pebble Watch app to open and close the door as well."
                            self.vcTextView.alpha = 1.0
